...
function envoyerReaction(typeReaction, idPublication, idCompte) {
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      document
        .getElementById("jaime-" + idPublication)
        .classList.remove("bg-blue-500");
      document
        .getElementById("jadore-" + idPublication)
        .classList.remove("bg-blue-500");
      document
        .getElementById("haha-" + idPublication)
        .classList.remove("bg-blue-500");
      document
        .getElementById("triste-" + idPublication)
        .classList.remove("bg-blue-500");

      // Ajout de la classe 'bg-blue-500' au bouton correspondant à la réaction de l'utilisateur
      document
        .getElementById(typeReaction + "-" + idPublication)
  ...
  xhr.open(
    "GET",
    "../react_pub/insert_reaction.php?type=" +
      typeReaction +
      "&id_publication=" +
      idPublication +
      "&id_compte=" +
